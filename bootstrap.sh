...
echo "==> Step 2: symlink this repo to ~/.maconfig"
# home.nix resolves its mkOutOfStoreSymlink paths through ~/.maconfig, so this
...
echo "==> Step 4: back up existing configs home-manager would clobber"
...
sudo "$NIX_BIN" run github:nix-darwin/nix-darwin/nix-darwin-26.05#darwin-rebuild -- \
  switch --flake ~/.maconfig#"$FLAKE_HOST"
